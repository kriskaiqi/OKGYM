...
import { ExerciseError, ExerciseStage } from '../../../types/ai/exercise';
import { SquatMetrics } from '../../../types/squat';

interface SquatOverlayProps {
  metrics: SquatMetrics;
  errors: ExerciseError[];
  isLiveMode?: boolean; // Add prop to detect live mode
}

const SquatOverlay: React.FC<SquatOverlayProps> = ({ 
  metrics, 
  errors,
  isLiveMode = false // Default to false (upload mode)
}) => {
  // Extract metrics
