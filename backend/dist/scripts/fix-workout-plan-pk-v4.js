    ...
    try {
        ...
        try {
            ...
            await queryRunner.query(`
                DROP INDEX IF EXISTS "idx_workout_name";
                DROP INDEX IF EXISTS "idx_workout_description";
                DROP INDEX IF EXISTS "idx_workout_difficulty";
                DROP INDEX IF EXISTS "idx_workout_estimatedDuration";
                DROP INDEX IF EXISTS "idx_workout_isCustom";
                DROP INDEX IF EXISTS "idx_workout_category";
                DROP INDEX IF EXISTS "idx_workout_estimatedCaloriesBurn";
                DROP INDEX IF EXISTS "idx_workout_video_media_id";
                DROP INDEX IF EXISTS "idx_workout_thumbnail_media_id";
                DROP INDEX IF EXISTS "idx_workout_creator";
                DROP INDEX IF EXISTS "idx_workout_creator_id";
                DROP INDEX IF EXISTS "IDX_19391f44e4e399c4bb8c7e97b4";
                DROP INDEX IF EXISTS "idx_workout_createdAt";
                DROP INDEX IF EXISTS "idx_workout_updatedAt";
                DROP INDEX IF EXISTS "IDX_workout_creator_custom";
                DROP INDEX IF EXISTS "IDX_workout_difficulty_category";
                DROP INDEX IF EXISTS "idx_workout_filter";
                DROP INDEX IF EXISTS "idx_workout_newest";
                DROP INDEX IF EXISTS "idx_workout_popularity";
                DROP INDEX IF EXISTS "idx_workout_rating";
                DROP INDEX IF EXISTS "idx_workout_search"
            `);
            console.log("Dropped all indexes");
            console.log("\nDropping primary key constraint with CASCADE...");
            await queryRunner.query(`
...
fixWorkoutPlanPK();
//# sourceMappingURL=fix-workout-plan-pk-v4.js.map