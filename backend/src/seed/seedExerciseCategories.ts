...
/**
 * Seed the database with exercise categories (muscle groups, exercise types, and special categories)
 * Total: 30 records as specified in the seeding plan
 */
export async function seedExerciseCategories(): Promise<void> {
  try {
    ...
    if (existingCount > 0) {
      logger.info(`Database already has ${existingCount} exercise categories. Skipping seed.`);
      return;
    }
    
    // Create 10 primary muscle groups categories
    const muscleGroupsData = [
      {
        ...
        metadata: {
          ...
          relatedCategories: [3, 5], // Shoulders, Triceps
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [3, 4, 6], // Shoulders, Biceps, Forearms
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [1, 2, 5], // Chest, Back, Triceps
      ...
      },
      {
        ...
        metadata: {
          ...
          relatedCategories: [2, 6], // Back, Forearms
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2 times per week',
          relatedCategories: [1, 3], // Chest, Shoulders
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2 times per week',
          relatedCategories: [4, 2], // Biceps, Back
      ...
      },
      {
        ...
        metadata: {
          ...
          relatedCategories: [8, 9, 10], // Quadriceps, Hamstrings, Glutes
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2 times per week',
          relatedCategories: [9, 10], // Hamstrings, Glutes
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2 times per week',
          relatedCategories: [8, 10], // Quadriceps, Glutes
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [8, 9], // Quadriceps, Hamstrings
    ...
    // Create 10 exercise types categories (using MOVEMENT_PATTERN and SPECIAL types)
    const exerciseTypesData = [
      {
        ...
        type: CategoryType.MOVEMENT_PATTERN,
        displayOrder: 11,
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [12, 15], // Strength_Isolation, Power
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [11, 15], // Strength_Compound, Power
      ...
      },
      {
        ...
        metadata: {
          ...
          relatedCategories: [19, 29], // Recovery, Endurance
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '3-4 times per week',
          relatedCategories: [7, 30], // Core (muscle group), Stability
      ...
      },
      {
        ...
        metadata: {
          ...
          relatedCategories: [11, 16], // Strength_Compound, Plyometric
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '1-2 times per week',
          relatedCategories: [15, 25], // Power, HIIT
      ...
      },
      {
        ...
        metadata: {
          ...
          relatedCategories: [19, 28], // Recovery, Mobility
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [30, 14], // Stability, Core
      ...
      },
      {
        ...
        metadata: {
          ...
          relatedCategories: [17, 22], // Flexibility, Rehabilitation
      ...
      },
      {
        ...
        metadata: {
          ...
          relatedCategories: [15, 16, 21], // Power, Plyometric, Functional
    ...
    const specialCategoriesData = [
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [11, 30], // Strength_Compound, Stability
      ...
      },
      {
        ...
        type: CategoryType.EXPERIENCE_LEVEL,
        displayOrder: 23,
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [26, 12], // Bodyweight, Strength_Isolation
      ...
      },
      {
        ...
        metadata: {
          ...
          relatedCategories: [15, 20], // Power, Sport_Specific
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [13, 16], // Cardio, Plyometric
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '3-5 times per week',
          relatedCategories: [23, 27], // Beginner_Friendly, Equipment_Based
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '3-4 times per week',
          relatedCategories: [26, 11], // Bodyweight, Strength_Compound
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '3-5 times per week',
          relatedCategories: [13, 19], // Cardio, Recovery
      ...
      },
      {
        ...
        metadata: {
          ...
          recommendedFrequency: '2-3 times per week',
          relatedCategories: [14, 18], // Core, Balance
    ...
    logger.info(`Successfully seeded ${allCategoriesData.length} exercise categories (10 muscle groups, 10 exercise types, 10 special categories)`);
  } catch (error) {
    logger.error('Error seeding exercise categories:', error);
    throw error;
  }
} 