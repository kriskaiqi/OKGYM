...
export interface RelationConfig {
  ...
  relatedEntity: string | EntityTarget<any>;
}

export const EntityRelationships: Record<string, Record<string, RelationConfig>> = {
  Exercise: {
    categories: {
    ...
    relationsFrom: {
      ...
      relationIdField: 'id', // Using the relation table's PK
  ...
  User: {
    ...
    favoriteWorkouts: {
      ...
      entityIdField: 'user_id',
      relationIdField: 'workout_id', // Note: workout_id might be stored as an integer in the database
  ...
  WorkoutSession: {
    ...
    workoutPlan: {
      joinTable: 'workout_sessions',
      entityIdField: 'id', // This session.id is a UUID
      relationIdField: 'workout_plan_id', // This is an integer
      relatedEntity: 'WorkoutPlan'
    },
    metrics: {
      joinTable: 'metric_tracking',
